...
export default function Home() {
  ...
  async function fetchProducts(){
    await axios.get("https://ecommerce-project-z08c.onrender.com/api/product")
      .then((res)=>{
        console.log(res)
  ...
  async function addCart(productId){
    ...
    try{
      await axios.post("https://ecommerce-project-z08c.onrender.com/api/cart/add",{productId},{
