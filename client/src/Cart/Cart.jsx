...
export default function Cart() {
    ...
    async function fetchCartProducts() {
        await axios.get("https://ecommerce-project-z08c.onrender.com/api/cart", {
    ...
    async function removeFromCart(productId){
        try{
            await axios.delete(`https://ecommerce-project-z08c.onrender.com/api/cart/remove/${productId}`,{
                headers:{Authorization:`Bearer ${user.token}`}
            })
            .then((res)=>{
